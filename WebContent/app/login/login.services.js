    ...
    function (Base64, $http, $cookieStore, $rootScope, $timeout) {
        ...
        service.Login = function (username, password, clientType, callback) {
            ...
            /* Dummy authentication for testing, uses $timeout to simulate api call
             ----------------------------------------------*/
            $timeout(function(){
                var response = { success: username === 'admin' && password === '1234' && clientType=='ADMIN'};
                if(!response.success) {
            ...
            /* Use this for real authentication
             ----------------------------------------------*/
//            $http.get("http://localhost:8080/LoginWebDemo/coupon/login/"
//                    + username + "/"
//                    + password + "/"
//                    + clientType)
...
//                });
        ...
        service.SetCredentials = function (username, password, clientType) {
            var authdata = Base64.encode(username + ':' + password + ':' + clientType);
